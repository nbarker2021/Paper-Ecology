# SQLLib — Paper-Attached Code Artifacts & Disposition Directive
...
- **Action:** Evaluate each item. If it generates/validates Canon content, integrate into the relevant `paper-XX__` and move the item to a dedicated tooling repo (NOT in SQLLib). **DELETE this folder once harvested.**
