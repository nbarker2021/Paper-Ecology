# SMD-03 Workbook - Gauge Group SU3 SU2 U1 And Representation Content

## Purpose

This workbook turns `SMD-03` into a concrete Standard Model definition and comparator exercise. It is not a blank checklist. It is the place where a reviewer can take a
...
|---|---|---|---|
| Theorem 03.1 | `standard_theorem_citation_bound_result` | Particle-facing labels require representation rows, not analogies: every LCR face, color, or charge claim must name the corresponding representation field. | Attach source/receipt/comparator and mark closure state. |
| Proposition 03.2 | `normal_form_result` | This definition can be consumed by an FLCR paper only after the external object, LCR mapping, boundary, and destination paper are named. | Attach source/receipt/comparator and mark closure state. |
...
|---|---|---|
| Closure row 1 | Close structural representation claims when the group, representation, and transformation rule are stated. | Cite in destination paper only at stated scope. |
| Closure row 2 | Close LCR face/color correspondence only at the structural level unless measured particle data are added. | Cite in destination paper only at stated scope. |

## Open Or Calibration-Bound Rows

| Row | Obligation | Required next evidence |
|---|---|---|
| Obligation 1 | Particle identity remains open without field assignment and data/citation binding. | Route to calibration, comparator, or falsifier. |
| Obligation 2 | Numerical parameter agreement is calibration-bound. | Route to calibration, comparator, or falsifier. |

## Destination FLCR Routing

| Destination | Required use |
|---|---|
| FLCR-01 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-31 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-32 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-33 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-40 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-02 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-18 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-19 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-30 | Cite `SMD-03` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
...
| External object | Name the Standard Model or standard-physics object defined by `SMD-03`. |
...
```text
claim -> SMD-03 definition -> destination FLCR dependency -> lane
...
```text
SMD-03 source registry
SMD-03 destination FLCR-01 FLCR-31 FLCR-32 FLCR-33 FLCR-40 FLCR-02 FLCR-18 FLCR-19 FLCR-30
SMD-03 closure rows
SMD-03 comparator falsifier boundary
SMD-03 CAM crystal reapplication evidence
```
