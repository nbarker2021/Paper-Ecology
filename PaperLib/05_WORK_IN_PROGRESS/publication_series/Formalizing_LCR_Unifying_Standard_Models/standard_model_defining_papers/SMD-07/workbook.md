# SMD-07 Workbook - Higgs Sector, Vacuum Structure, And Mass Terms

## Purpose

This workbook turns `SMD-07` into a concrete Standard Model definition and comparator exercise. It is not a blank checklist. It is the place where a reviewer can take a
...
|---|---|---|---|
| Theorem 07.1 | `standard_theorem_citation_bound_result` | Mass-residue translation is admissible only when it names whether the row is scalar-sector, Yukawa-sector, gauge-mass, or LCR bookkeeping. | Attach source/receipt/comparator and mark closure state. |
| Proposition 07.2 | `normal_form_result` | This definition can be consumed by an FLCR paper only after the external object, LCR mapping, boundary, and destination paper are named. | Attach source/receipt/comparator and mark closure state. |
...
|---|---|---|
| Closure row 1 | Close Higgs-sector definition and the distinction between scalar, Yukawa, and gauge-mass rows. | Cite in destination paper only at stated scope. |
| Closure row 2 | Close LCR mass-residue bookkeeping as internal structure when FLCR receipts are cited. | Cite in destination paper only at stated scope. |

## Open Or Calibration-Bound Rows

| Row | Obligation | Required next evidence |
|---|---|---|
| Obligation 1 | Observed Higgs mass and coupling modifiers require external collider data. | Route to calibration, comparator, or falsifier. |
| Obligation 2 | Mass residue is not a measured Higgs mechanism unless the bridge supplies data and equations. | Route to calibration, comparator, or falsifier. |

## Destination FLCR Routing

| Destination | Required use |
|---|---|
| FLCR-01 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-33 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-34 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-40 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-31 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-02 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-18 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-19 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-30 | Cite `SMD-07` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
...
| External object | Name the Standard Model or standard-physics object defined by `SMD-07`. |
...
```text
claim -> SMD-07 definition -> destination FLCR dependency -> lane
...
```text
SMD-07 source registry
SMD-07 destination FLCR-01 FLCR-33 FLCR-34 FLCR-40 FLCR-31 FLCR-02 FLCR-18 FLCR-19 FLCR-30
SMD-07 closure rows
SMD-07 comparator falsifier boundary
SMD-07 CAM crystal reapplication evidence
```
