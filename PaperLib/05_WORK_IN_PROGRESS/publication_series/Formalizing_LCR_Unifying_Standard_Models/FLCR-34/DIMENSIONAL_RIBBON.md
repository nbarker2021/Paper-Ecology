# Dimensional Ribbon Role - FLCR-34
...
order-4 slot-4 action: turn boundary failure into typed repair or curvature demand
...
| Link | Slot |
|---|---|
| Same family, previous lift | `24` |
| Same family, next lift | `44` |
| Previous slot in window | `33` |
| Next slot in window | `35` |
