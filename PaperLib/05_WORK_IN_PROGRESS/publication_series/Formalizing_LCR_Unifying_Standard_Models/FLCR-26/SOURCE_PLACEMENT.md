# Source Placement - FLCR-26 - Observer Delay And Shared-State Protocols
...
| `ORBITAL_DATA_CROSS_POPULATION_AUDIT.md` | claim-nature split required here: static structure vs temporal protocol |
