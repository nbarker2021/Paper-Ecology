...
**Proposition 23.2.** game lattice automaton can be imported by later papers only through its declared source, receipt, and lane.

**Protocol 23.3.** complete game theory, playability, OEIS review, and real-piece geometry remain external review lanes

### Claim lane reference

| Claim | Lane |
|---|---|
| Theorem 23.1 | `receipt_bound_internal_result` |
| Proposition 23.2 | `normal_form_result` |
| Protocol 23.3 | `falsifier_or_open_obligation` |
...
The proof strategy for FLCR-23 is a typed construction argument. The paper names game lattice as the active object, binds it to the routed legacy and orbital sources, and then allows downstream use only through the declared claim lane. This preserves the full forward program: stronger ambitions remain explicit dependencies, calibration tasks, and falsifiers on the path to literal physics.
...
**Full audit assembly:** [`../ASSEMBLED_FLCR_PRODUCTS/FLCR-23__Finite_Game_Lattices_And_Local_Rule_Automata__assembled.md`](../ASSEMBLED_FLCR_PRODUCTS/FLCR-23__Finite_Game_Lattices_And_Local_Rule_Automata__assembled.md)
**Source truth:** `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-23\formal.md`
...
_… and 136 additional receipt references in the assembled audit product._
...
_Maximal reader manuscript — prose tier `maximal_publication` · renderer `full_formal_body_v2` · audit: `../ASSEMBLED_FLCR_PRODUCTS/FLCR-23__Finite_Game_Lattices_And_Local_Rule_Automata__assembled.md`._
