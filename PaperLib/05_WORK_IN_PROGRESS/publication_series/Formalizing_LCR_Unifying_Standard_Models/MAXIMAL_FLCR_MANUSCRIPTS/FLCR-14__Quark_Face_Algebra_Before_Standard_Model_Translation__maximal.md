...
**Proposition 14.2.** quark-face algebra can be imported by later papers only through its declared source, receipt, and lane.

**Protocol 14.3.** measured quark identity, CKM data, and physical color calibration are deferred to translation papers

### Claim lane reference

| Claim | Lane |
|---|---|
| Theorem 14.1 | `receipt_bound_internal_result` |
| Proposition 14.2 | `normal_form_result` |
| Protocol 14.3 | `falsifier_or_open_obligation` |
...
The proof strategy for FLCR-14 is a typed construction argument. The paper names face algebra as the active object, binds it to the routed legacy and orbital sources, and then allows downstream use only through the declared claim lane. This preserves the full forward program: stronger ambitions remain explicit dependencies, calibration tasks, and falsifiers on the path to literal physics.
...
**Full audit assembly:** [`../ASSEMBLED_FLCR_PRODUCTS/FLCR-14__Quark_Face_Algebra_Before_Standard_Model_Translation__assembled.md`](../ASSEMBLED_FLCR_PRODUCTS/FLCR-14__Quark_Face_Algebra_Before_Standard_Model_Translation__assembled.md)
**Source truth:** `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-14\formal.md`
...
| `D:\CQE_CMPLX\kernel\staging\papers\suite81_claude_codex_memory\Memos between CL_CX_HM\2026-06-13_14-20-42-0700_CX-to-CL-HM_Paper05-Paper08-Receipt-Binding-Update.md` | no | timeline_node |
| `D:\CQE_CMPLX\kernel\staging\papers\suite81_claude_codex_memory\Memos between CL_CX_HM\2026-06-14_14-05-25-0700_CL-to-HM-CX_Reverse-Pass-32-to-28-Affirmative-Upgrades-Plus-Interpretive-Receipts-Folded.md` | no | timeline_node |
| `quark_face_transport_literalized_receipt.json` | no | formal_md |
| `quark_face_transport_receipt.json` | no | formal_md |
...
_Maximal reader manuscript — prose tier `maximal_publication` · renderer `full_formal_body_v2` · audit: `../ASSEMBLED_FLCR_PRODUCTS/FLCR-14__Quark_Face_Algebra_Before_Standard_Model_Translation__assembled.md`._
