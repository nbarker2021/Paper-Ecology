...
Theorem 36.1: forge-generated material candidates can be translated into condensed-matter hypotheses when descriptors, band context, and validation lane are attached
...
**Proposition 36.2.** materials translation can be imported by later papers only through its declared source, receipt, and lane.

**Protocol 36.3.** fabrication, finite-element performance, spectroscopy, and device claims remain empirical

### Claim lane reference

| Claim | Lane |
|---|---|
| Theorem 36.1 | `external_calibration_result` |
| Proposition 36.2 | `normal_form_result` |
| Protocol 36.3 | `falsifier_or_open_obligation` |
...
The proof strategy for FLCR-36 is a typed construction argument. The paper names material hypothesis as the active object, binds it to the routed legacy and orbital sources, and then allows downstream use only through the declared claim lane. This preserves the full forward program: stronger ambitions remain explicit dependencies, calibration tasks, and falsifiers on the path to literal physics.
...
**Full audit assembly:** [`../ASSEMBLED_FLCR_PRODUCTS/FLCR-36__Condensed_Matter_Materials_And_Metamaterials__assembled.md`](../ASSEMBLED_FLCR_PRODUCTS/FLCR-36__Condensed_Matter_Materials_And_Metamaterials__assembled.md)
**Source truth:** `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-36\formal.md`
...
_… and 147 additional receipt references in the assembled audit product._
...
- `LOCAL-GAP-0003`
- `LOCAL-GAP-0004`
- _… and 46 more in assembled product._
...
_Maximal reader manuscript — prose tier `maximal_publication` · renderer `full_formal_body_v2` · audit: `../ASSEMBLED_FLCR_PRODUCTS/FLCR-36__Condensed_Matter_Materials_And_Metamaterials__assembled.md`._
