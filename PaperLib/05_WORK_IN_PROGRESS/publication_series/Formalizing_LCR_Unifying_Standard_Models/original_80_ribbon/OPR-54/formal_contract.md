# Formal Contract - OPR-54

## Formal Carrier

This slot uses `boundary_action` at lift depth `5` to produce the following proof
form:
...
order-6 slot-4: type the boundary, repair row, or curvature-demand condition
