# Formal Contract - OPR-73

## Formal Carrier

This slot uses `fold_action` at lift depth `7` to produce the following proof
form:
...
order-8 slot-3: fold the initial action into a higher-dimensional representation
