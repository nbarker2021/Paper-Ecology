# Formal Contract - OPR-72

## Formal Carrier

This slot uses `residual_action` at lift depth `7` to produce the following proof
form:
...
order-8 slot-2: mark the correction, residue, vacancy, or mismatch surface
