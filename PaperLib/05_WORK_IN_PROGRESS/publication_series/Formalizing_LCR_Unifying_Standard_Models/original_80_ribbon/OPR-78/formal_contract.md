# Formal Contract - OPR-78

## Formal Carrier

This slot uses `terminal_action` at lift depth `7` to produce the following proof
form:
...
order-8 slot-8: land into lattice, game, runtime, or terminal address surfaces
