# Formal Contract - OPR-66

## Formal Carrier

This slot uses `ledger_action` at lift depth `6` to produce the following proof
form:
...
order-7 slot-6: bind state into causal, observer, or synchronization ledgers
