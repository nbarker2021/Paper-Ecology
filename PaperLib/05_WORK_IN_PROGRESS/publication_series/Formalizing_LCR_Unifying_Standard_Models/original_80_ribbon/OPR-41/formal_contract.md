# Formal Contract - OPR-41

## Formal Carrier

This slot uses `enumeration_action` at lift depth `4` to produce the following proof
form:
...
order-5 slot-1: start the active one-dimensional action / enumerate the center state
