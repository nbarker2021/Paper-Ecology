# Formal Contract - OPR-71

## Formal Carrier

This slot uses `enumeration_action` at lift depth `7` to produce the following proof
form:
...
order-8 slot-1: start the active one-dimensional action / enumerate the center state
