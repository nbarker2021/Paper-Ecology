# Formal Contract - OPR-67

## Formal Carrier

This slot uses `bridge_action` at lift depth `6` to produce the following proof
form:
...
order-7 slot-7: project between discrete, continuous, lattice, or physical-facing forms
