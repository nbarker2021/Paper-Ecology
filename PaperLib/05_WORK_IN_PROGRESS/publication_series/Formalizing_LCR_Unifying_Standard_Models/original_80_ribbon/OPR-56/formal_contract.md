# Formal Contract - OPR-56

## Formal Carrier

This slot uses `ledger_action` at lift depth `5` to produce the following proof
form:
...
order-6 slot-6: bind state into causal, observer, or synchronization ledgers
