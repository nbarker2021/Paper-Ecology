# Formal Contract - OPR-35

## Formal Carrier

This slot uses `carrier_action` at lift depth `3` to produce the following proof
form:
...
order-4 slot-5: carry the state through a path, traversal, or admissible motion
