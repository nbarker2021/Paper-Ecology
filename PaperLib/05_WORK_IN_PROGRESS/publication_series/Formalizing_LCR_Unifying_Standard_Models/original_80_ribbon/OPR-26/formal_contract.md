# Formal Contract - OPR-26

## Formal Carrier

This slot uses `ledger_action` at lift depth `2` to produce the following proof
form:
...
order-3 slot-6: bind state into causal, observer, or synchronization ledgers
