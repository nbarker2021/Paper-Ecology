# Formal Contract - OPR-48

## Formal Carrier

This slot uses `terminal_action` at lift depth `4` to produce the following proof
form:
...
order-5 slot-8: land into lattice, game, runtime, or terminal address surfaces
