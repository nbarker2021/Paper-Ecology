# Formal Contract - OPR-42

## Formal Carrier

This slot uses `residual_action` at lift depth `4` to produce the following proof
form:
...
order-5 slot-2: mark the correction, residue, vacancy, or mismatch surface
