# Formal Contract - OPR-11

## Formal Carrier

This slot uses `enumeration_action` at lift depth `1` to produce the following proof
form:
...
order-2 slot-1: start the active one-dimensional action / enumerate the center state
