# Formal Contract - OPR-69

## Formal Carrier

This slot uses `window_action` at lift depth `6` to produce the following proof
form:
...
order-7 slot-9: read the ribbon through windows, meta-readouts, or synthesis bands
