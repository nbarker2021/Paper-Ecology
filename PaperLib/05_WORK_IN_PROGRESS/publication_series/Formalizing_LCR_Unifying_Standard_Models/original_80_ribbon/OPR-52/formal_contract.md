# Formal Contract - OPR-52

## Formal Carrier

This slot uses `residual_action` at lift depth `5` to produce the following proof
form:
...
order-6 slot-2: mark the correction, residue, vacancy, or mismatch surface
