# Source Placement - FLCR-39 - Falsifiers, Comparators, And Standards Of Evidence
...
| `NEW_PAPER_NEEDS.md` | route relevant obligations into this paper's burden table: NP-09 Sporadic Boundary Invariance And Encoder Dependence |
| `NEW_PAPER_NEEDS.md` | route relevant obligations into this paper's burden table: NP-11 Superpermutation Minimality And Supervisor Cursor Bounds |
...
| `ORBITAL_DATA_CROSS_POPULATION_AUDIT.md` | claim-nature split required here: finite verification vs unbounded generalization |
| `ORBITAL_DATA_CROSS_POPULATION_AUDIT.md` | claim-nature split required here: negative and failed-route receipts |
