...
|---|---|---|---|
| EXT-FFS-THEORY-2026: Exotic critical states as fractional Fermi seas in the one-dimensional Bose gas; DOI `10.1103/j3s5-gjpf`; arXiv `2602.17656` | `falsifier_or_open_obligation` | Creates a concrete comparator: LCR condensed-matter claims should be tested against fractional Fermi sea occupancy, Friedel oscillations, generalized hydrodynamics, and TLL-incompatibility claims. | Failure to match those external signatures is a falsifier or narrowing condition for relevant LCR material claims. |
| EXT-RQM-CONSISTENT-2026: Quantum mechanics based on real numbers: A consistent description; DOI `10.1103/4k13-sdjh`; arXiv `2503.17307` | `falsifier_or_open_obligation` | Creates a representation-equivalence comparator: LCR relabeling claims must specify the postulates and adapters under which predictions are preserved. | A relabeling without an equivalence proof remains only notation. |
...
|---|---|---|---|
| paper lift enumeration | `receipt_bound_internal_result` | 8/8 LCR states succeeded; error walls=0; avg TarPit mass=0.505223. | This closes the paper-local finite lift readout, not every stronger physical interpretation. |
...
| validation authority | `normal_form_result` | Validation is closed as a multi-lane comparator/falsifier protocol. | Only rows missing required fields remain unresolved. |
