...
\usepackage{array}
\begin{document}
\section*{FLCR-24 - Energetic Traversal Maps}
...
\noindent{}-- Defines energetic traversal map as a first-class FLCR object.\\
\noindent{}-- States the local result: internal traversal ledgers can order and compare path costs under declared scalar rules.\\
\noindent{}-- Routes downstream use through claim lanes rather than inherited prose: FLCR-37 may translate this into energy/plasma language only with units and measurement lanes.\\
\noindent{}-- Preserves the residue boundary: joule conversion, thermodynamic identity, and physical energy claims require calibration.\\
...
\noindent{}-- `virtuous/25\_Energetic\_Traversal\_Maps\_VIRTUOUS.md`\\
\noindent{}-- `supplements/25\_INTERNAL\_REASONING\_SUPPLEMENT.md`\\
...
\noindent{}-- **Traversal cost.** A scalar attached to a path under the internal ledger rule.\\
\noindent{}-- **Energy calibration.** The external binding that turns ledger cost into physical units.\\
...
\noindent\texttt{|-------|------|-----------|}\\
\noindent\texttt{| Theorem 24.1 | `receipt\_bound\_internal\_result` | internal traversal ledgers can order and compare path costs under declared scalar rules |}\\
\noindent\texttt{| Proposition 24.2 | `normal\_form\_result` | energetic traversal map can be imported by later papers only through its declared source, receipt, and lane. |}\\
\noindent\texttt{| Protocol 24.3 | `falsifier\_or\_open\_obligation` | joule conversion, thermodynamic identity, and physical energy claims require calibration |}\\
...
\noindent\texttt{|---|---|---|---|---|---|}\\
\noindent\texttt{| Theorem 24.1 | finite/executable result | internal traversal ledgers can order and compare path costs under declared scalar rules | receipt, validator, executable pass, generated artifact, or finite enumeration | the s}\\
\noindent\texttt{| Proposition 24.2 | formal construction | energetic traversal map can be imported by later papers only through its declared source, receipt, and lane | definitions, normal-form construction, conversion rule, and downstr}\\
\noindent\texttt{| Protocol 24.3 | obligation/falsifier | joule conversion, thermodynamic identity, and physical energy claims require calibration | explicit missing derivation, adapter, receipt, dataset, comparator, or failed test condi}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| Formal-system result | `FLCR-24` defines or uses **Energetic Traversal Maps** as a typed FLCR object with declared inputs, operations, outputs, and residue. | Definitions, formal claims, construction steps, and downstr}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| paper lift enumeration | `receipt\_bound\_internal\_result` | 8/8 LCR states succeeded; error walls=0; avg TarPit mass=0.503217. | This closes the paper-local finite lift readout, not every stronger physical interpretatio}\\
...
\noindent\texttt{| energetic traversal map | `cam\_crystal\_reapplication\_result` | Traversal maps are closed as bounded energy/path ledgers. | Measured energy transfer requires unitful calibration. |}\\
...
\noindent{}-- joule conversion, thermodynamic identity, and physical energy claims require calibration\\
...
Assigned original ribbon role(s): `25`/carrier\_action.
...
\noindent\texttt{| Additional evidence cards | 16 total | The complete card inventory is maintained in the archive evidence matrix. | Cards are source-discovery aids until bound to paper-local evidence. |}\\
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| Publication ID | `FLCR-24` |}\\
\noindent\texttt{| Legacy source slot(s) | `25` |}\\
...
\noindent\texttt{| Produced state | formal result of original slot 25 plus the same-family lift path toward slot 35 |}\\

\subsubsection*{Claim-Evidence Table}

\noindent\texttt{| Claim | Lane | Evidence to attach | Boundary |}\\
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| Theorem 24.1 | `receipt\_bound\_internal\_result` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | internal traversal ledgers can order and compare path costs under declared scalar r}\\
\noindent\texttt{| Proposition 24.2 | `normal\_form\_result` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | energetic traversal map can be imported by later papers only through its declared source, }\\
\noindent\texttt{| Protocol 24.3 | `falsifier\_or\_open\_obligation` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | joule conversion, thermodynamic identity, and physical energy claims require calibr}\\

\subsubsection*{Figure Plan}

\noindent\texttt{| Figure | Purpose | Caption |}\\
\noindent\texttt{|---|---|---|}\\
\noindent\texttt{| FLCR-24-F1 | Carrier path and invariant payload | Schematic showing how `FLCR-24` turns its received state into the produced state while preserving claim lanes and residue boundaries. |}\\
\noindent\texttt{| FLCR-24-F2 | Evidence routing map | Diagram of source papers, archive cards, CAM/crystal routes, validators, and workbook replay paths used by this manuscript. |}\\
\noindent\texttt{| FLCR-24-F3 | Same-family lift context | Diagram placing this paper in the original `00-79` ribbon family and showing predecessor/successor slots. |}\\

\subsubsection*{In-Text Figure FLCR-24-F1: Carrier path and invariant payload}
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-24-T1 | Carrier transport table |}\\
\noindent\texttt{| FLCR-24-T2 | Claim-lane/evidence-boundary table |}\\
\noindent\texttt{| FLCR-24-T3 | Archive evidence card and source-backed upgrade table |}\\
\noindent\texttt{| FLCR-24-T4 | Workbook replay and falsifier table |}\\
...
\subsubsection*{Appendix FLCR-24-A: Evidence Package}
...
`FLCR-24` (`Energetic Traversal Maps`) occupies the `carrier\_action` role at lift depth `2`.
...
\noindent\texttt{|---|---|---|}\\
\noindent\texttt{| Legacy sources | `25\_Energetic\_Traversal\_Maps.md`, `virtuous/25\_Energetic\_Traversal\_Maps\_VIRTUOUS.md`, `supplements/25\_INTERNAL\_REASONING\_SUPPLEMENT.md` | routed evidence |}\\
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-24-F1: Carrier path and invariant payload | Visualizes the proof object, routing, or boundary. |}\\
\noindent\texttt{| FLCR-24-F2: Evidence routing map | Visualizes the proof object, routing, or boundary. |}\\
\noindent\texttt{| FLCR-24-F3: Same-family lift context | Visualizes the proof object, routing, or boundary. |}\\

\noindent\texttt{| Table | Role |}\\
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-24-T1: Carrier transport table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-24-T2: Claim-lane/evidence-boundary table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-24-T3: Archive evidence card and source-backed upgrade table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-24-T4: Workbook replay and falsifier table | Records claim lanes, evidence, sources, or falsifiers. |}\\
