...
```text
received state -> Energetic Traversal Maps -> produced state
```
...
For `FLCR-24`, the most important figure is `FLCR-24-F1`: Carrier path and invariant payload.
The most important table is `FLCR-24-T1`: Carrier transport table.
