# FLCR-36 Companion - Condensed Matter, Materials, And Metamaterials
...
```text
received state -> Condensed Matter, Materials, And Metamaterials -> produced state
```
...
This paper now binds an actual MetaForge materials receipt. The receipt closes a replayable candidate-generation ledger: finite material inventory, Pareto partner selection, ten-fold evaluation, seam proposal, production accounting, and replay over multiple material pairs.

Reader translation: the materials generator is operationally real as a candidate-ledger tool. It does not yet claim fabricated performance, measured stress-strain behavior, finite-element validation, or material property confirmation.
...
For `FLCR-36`, the most important figure is `FLCR-36-F1`: Residual split diagram.
The most important table is `FLCR-36-T1`: Residual accounting table.
