# Dimensional Ribbon Role - FLCR-36
...
order-4 slot-6 action: bind the carried state into causal edges or observer buffers
...
| Link | Slot |
|---|---|
| Same family, previous lift | `26` |
| Same family, next lift | `46` |
| Previous slot in window | `35` |
| Next slot in window | `37` |
