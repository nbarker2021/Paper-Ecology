# Dimensional Ribbon Role - FLCR-04
...
order-1 slot-4 action: turn boundary failure into typed repair or curvature demand
...
| Same family, next lift | `14` |
| Previous slot in window | `03` |
| Next slot in window | `05` |
