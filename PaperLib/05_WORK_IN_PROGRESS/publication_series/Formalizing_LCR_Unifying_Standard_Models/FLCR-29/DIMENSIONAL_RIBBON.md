# Dimensional Ribbon Role - FLCR-29
...
order-3 slot-9 action: read the ribbon through temporal, observer, meta, or synthesis windows
...
| Link | Slot |
|---|---|
| Same family, previous lift | `19` |
| Same family, next lift | `39` |
| Previous slot in window | `28` |
| Next slot in window | `30` |
