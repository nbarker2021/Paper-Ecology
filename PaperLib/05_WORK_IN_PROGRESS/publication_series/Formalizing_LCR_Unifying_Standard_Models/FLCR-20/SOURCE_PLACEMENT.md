# Source Placement - FLCR-20 - Applied Forge Reader And Descriptor Kernel
...
| `NEW_PAPER_NEEDS.md` | route relevant obligations into this paper's burden table: NP-02 Niemeier Glue, Leech Invariants, And Gamma72 Landing |
| `NEW_PAPER_NEEDS.md` | route relevant obligations into this paper's burden table: NP-07 Applied Forge Validation |
...
| `ORBITAL_DATA_CROSS_POPULATION_AUDIT.md` | claim-nature split required here: lookup/construction/invariant split |
| `ORBITAL_DATA_CROSS_POPULATION_AUDIT.md` | claim-nature split required here: applied forge internal/external validation |
