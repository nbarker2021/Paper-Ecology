# FLCR-20 Workbook - Applied Forge Reader And Descriptor Kernel
...
- The `formal.md` file for `FLCR-20`.
...
| Step | Action |
|------|--------|
| Step 1 | Reconstruct the local object: forge descriptor kernel. |
| Step 2 | Write the receipt row that would demonstrate: applied forge descriptors can read, combine, and route LCR-addressed objects without changing the underlying CAM claim state. |
| Step 3 | Route the residue without promoting it: domain performance, external benchmarks, and real-world utility remain external validation tasks. |
...
| additional routed sources | 16 more entries remain in `SOURCE_PLACEMENT.md` |
...
|---|---|---|
| Leech E8 Golay Lookup | Run or cite the lattice-forge receipt, record parameters, and mark each row as lookup, construction, invariant, or residue. | Do not promote lookup into uniqueness, full invariant classification, Gamma72 closure, or physical interpretation without separate evidence. |
...
|---|---|---|
| Figures `FLCR-20-F1`, `FLCR-20-F2`, `FLCR-20-F3` | planned | Convert text schematics into final diagrams or leave as formal schematic figures. |
| Tables `FLCR-20-T1`-`FLCR-20-T4` | planned | Ensure all claim/evidence/source-card/workbook rows are complete. |
| Glossary | drafted | Replace generic term meanings with paper-local definitions. |
| Appendix FLCR-20-A | drafted | Attach receipt paths, verifier paths, source cards, and remaining external requirements. |
