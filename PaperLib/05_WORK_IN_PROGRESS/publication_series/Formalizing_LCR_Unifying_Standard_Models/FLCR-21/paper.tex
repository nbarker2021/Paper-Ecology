...
\usepackage{array}
\begin{document}
\section*{FLCR-21 - Materials Candidate Generation}
...
\noindent{}-- Defines materials forge as a first-class FLCR object.\\
\noindent{}-- States the local result: the internal representation and candidate-generation path can be receipt-bound before fabrication or finite-element validation.\\
\noindent{}-- Routes downstream use through claim lanes rather than inherited prose: FLCR-36 may translate this into condensed-matter/materials language with external datasets.\\
\noindent{}-- Preserves the residue boundary: fabrication, finite-element performance, measured band data, and material claims require external calibration.\\
...
\noindent{}-- `virtuous/22\_MetaForge\_Applied\_Materials\_VIRTUOUS.md`\\
\noindent{}-- `supplements/22\_INTERNAL\_REASONING\_SUPPLEMENT.md`\\
...
\noindent{}-- **Candidate row.** A generated material hypothesis with descriptors, source state, and validation lane.\\
\noindent{}-- **Fabrication boundary.** The point where internal generation ends and measured material validation begins.\\
...
\noindent\texttt{|-------|------|-----------|}\\
\noindent\texttt{| Theorem 21.1 | `cam\_crystal\_reapplication\_result` | the internal representation and candidate-generation path can be receipt-bound before fabrication or finite-element validation |}\\
\noindent\texttt{| Proposition 21.2 | `normal\_form\_result` | materials forge can be imported by later papers only through its declared source, receipt, and lane. |}\\
\noindent\texttt{| Protocol 21.3 | `falsifier\_or\_open\_obligation` | fabrication, finite-element performance, measured band data, and material claims require external calibration |}\\
...
\noindent\texttt{|---|---|---|---|---|---|}\\
\noindent\texttt{| Theorem 21.1 | CAM route | the internal representation and candidate-generation path can be receipt-bound before fabrication or finite-element validation | CAM/crystal route, source node, projection, window, or address}\\
\noindent\texttt{| Proposition 21.2 | formal construction | materials forge can be imported by later papers only through its declared source, receipt, and lane | definitions, normal-form construction, conversion rule, and downstream-use }\\
\noindent\texttt{| Protocol 21.3 | obligation/falsifier | fabrication, finite-element performance, measured band data, and material claims require external calibration | explicit missing derivation, adapter, receipt, dataset, comparator,}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| Formal-system result | `FLCR-21` defines or uses **Materials Candidate Generation** as a typed FLCR object with declared inputs, operations, outputs, and residue. | Definitions, formal claims, construction steps, and d}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| paper lift enumeration | `receipt\_bound\_internal\_result` | 8/8 LCR states succeeded; error walls=0; avg TarPit mass=0.508168. | This closes the paper-local finite lift readout, not every stronger physical interpretatio}\\
...
\noindent\texttt{| materials candidate ledger | `cam\_crystal\_reapplication\_result` | Materials generation is closed as a replayable candidate ledger. | Fabrication and load testing remain external validation. |}\\
...
\noindent{}-- fabrication, finite-element performance, measured band data, and material claims require external calibration\\
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| Publication ID | `FLCR-21` |}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| Theorem 21.1 | `cam\_crystal\_reapplication\_result` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | the internal representation and candidate-generation path can be receipt-bound b}\\
\noindent\texttt{| Proposition 21.2 | `normal\_form\_result` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | materials forge can be imported by later papers only through its declared source, receipt,}\\
\noindent\texttt{| Protocol 21.3 | `falsifier\_or\_open\_obligation` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | fabrication, finite-element performance, measured band data, and material claims re}\\

\subsubsection*{Figure Plan}

\noindent\texttt{| Figure | Purpose | Caption |}\\
\noindent\texttt{|---|---|---|}\\
\noindent\texttt{| FLCR-21-F1 | Residual split diagram | Schematic showing how `FLCR-21` turns its received state into the produced state while preserving claim lanes and residue boundaries. |}\\
\noindent\texttt{| FLCR-21-F2 | Evidence routing map | Diagram of source papers, archive cards, CAM/crystal routes, validators, and workbook replay paths used by this manuscript. |}\\
\noindent\texttt{| FLCR-21-F3 | Same-family lift context | Diagram placing this paper in the original `00-79` ribbon family and showing predecessor/successor slots. |}\\

\subsubsection*{In-Text Figure FLCR-21-F1: Residual split diagram}
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-21-T1 | Residual accounting table |}\\
\noindent\texttt{| FLCR-21-T2 | Claim-lane/evidence-boundary table |}\\
\noindent\texttt{| FLCR-21-T3 | Archive evidence card and source-backed upgrade table |}\\
\noindent\texttt{| FLCR-21-T4 | Workbook replay and falsifier table |}\\
...
\subsubsection*{Appendix FLCR-21-A: Evidence Package}
...
`FLCR-21` (`Materials Candidate Generation`) occupies the `residual\_action` role at lift depth `2`.
...
\noindent\texttt{|---|---|---|}\\
\noindent\texttt{| Legacy sources | `22\_MetaForge\_Applied\_Materials.md`, `virtuous/22\_MetaForge\_Applied\_Materials\_VIRTUOUS.md`, `supplements/22\_INTERNAL\_REASONING\_SUPPLEMENT.md`, `supplements/METAFORGE\_MATERIALS\_SUPPLEMENT.md` | routed e}\\
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-21-F1: Residual split diagram | Visualizes the proof object, routing, or boundary. |}\\
\noindent\texttt{| FLCR-21-F2: Evidence routing map | Visualizes the proof object, routing, or boundary. |}\\
\noindent\texttt{| FLCR-21-F3: Same-family lift context | Visualizes the proof object, routing, or boundary. |}\\

\noindent\texttt{| Table | Role |}\\
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-21-T1: Residual accounting table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-21-T2: Claim-lane/evidence-boundary table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-21-T3: Archive evidence card and source-backed upgrade table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-21-T4: Workbook replay and falsifier table | Records claim lanes, evidence, sources, or falsifiers. |}\\
