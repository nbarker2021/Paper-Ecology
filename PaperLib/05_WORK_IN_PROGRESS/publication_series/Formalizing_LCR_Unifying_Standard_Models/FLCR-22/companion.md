...
```text
received state -> Protein Descriptor And Fold-Facing Kernel -> produced state
```
...
For `FLCR-22`, the most important figure is `FLCR-22-F1`: Representation fold atlas.
The most important table is `FLCR-22-T1`: Face/representation correspondence table.
