...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-40\formal.md` |
| Evidence attached (review payload) | 2067 |
| Review pass | 30 |
...
_… and 144 more receipt references._
...
| PEEP-2026-021 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-022 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-025 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-030 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-033 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-005 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-021 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-022 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-025 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-030 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-031 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-032 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-033 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
| PEEP-2026-038 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
...
- `10.1007/s13398-025-01768-3` — **candidate** (seed; not paired to formal.md)
- `10.1016/j.inffus.2023.101896` — **candidate** (seed; not paired to formal.md)
...
|---|---|---|---|
| Timeline nodes | 860 | supporting_context | Provenance graph pass5 |
| Timeline edges | 320 | supporting_context | Includes zip crosswalk |
| Registry DISCOVERY rows | 0 | supporting_context | Not promoted |
| Seed candidates | 74 | external_candidates | IRL review appendix |
...
| PEEP-2026-019 | 10.25088/complexsystems.34.3.259 | ASSEMBLE | 85 | Rule30 Mophonics Field Theory Summary As CA Dynamics Comparator |
| PEEP-2026-037 | 10.1038/s41597-025-04905-0 | ASSEMBLE | 85 | FLCR-29 Corpus Ribbon As Machine-Readable Retrospective Comparator |
| PEEP-2026-039 | 10.1007/s00799-025-00431-x | REROUTE_OR_REPAIR | 85 | FLCR-39 Evidence Comparator As Provenance-Graph Comparator |
...
- `EQ-REG-0073` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| CLAIM-10.1016/j.inffus.202 | 10.1016/j.inffus.2023.101896 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-40 | 10.1016/j.inffus.2023.101896 | ingress_80_curated_seed | 0.55 | seed_only |
| EQ-REG-0013 | None | external_pair_queue_non_flcr | 0.5 | needs_external_doi |
| REG-0782e1 | None | registry_discovery_external_pair | 0.45 | unscored |
...
| LEGACY-TMN-CRYSTAL-001 |  | legacy_repo_ability_seed | 0.88 | not_applicable_legacy_ability_seed |
| LEGACY-TMN-MINT-003 |  | legacy_repo_ability_seed | 0.84 | not_applicable_legacy_ability_seed |
| LEGACY-MDGH-MMDB-005 |  | legacy_repo_ability_seed | 0.89 | not_applicable_legacy_ability_seed |
...
_… and 54 additional seed candidates._
...
|---|---|---|
| rule30_lineage | 527 | timeline_graph.pass5 |
| jordan_lineage | 278 | timeline_graph.pass5 |
| lattice_forge_lineage | 549 | timeline_graph.pass5 |
...
_Generated 2026-07-01T02:44:52.987265+00:00 — intake schema v1.1_
