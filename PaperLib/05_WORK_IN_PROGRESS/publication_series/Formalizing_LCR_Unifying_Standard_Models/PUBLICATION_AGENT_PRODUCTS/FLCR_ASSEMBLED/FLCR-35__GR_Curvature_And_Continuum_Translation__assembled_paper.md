...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-35\formal.md` |
| Evidence attached (review payload) | 832 |
| Review pass | 30 |
...
| 10.1038/s41467-025-66276-9 | nist_pass | peep_index | PASS | yes |

### Unpaired seed DOIs

- `10.1103/physrevd.103.122002` — **candidate** (seed; not paired to formal.md)
...
|---|---|---|---|
| Timeline nodes | 373 | supporting_context | Provenance graph pass5 |
| Timeline edges | 300 | supporting_context | Includes zip crosswalk |
...
| PEEP bindings (routed) | 9 | required_direct | Includes LOCAL-GAP |
...
| PEEP-2026-028 | 10.1038/s41467-025-66276-9 | ASSEMBLE | 85 | Exciton Transport Topology As Lift-Boundary Calibration Comparator |
...
- `EQ-REG-0068` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| CLAIM-10.1103/physrevd.103 | 10.1103/physrevd.103.122002 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-35 | 10.1103/physrevd.103.122002 | ingress_80_curated_seed | 0.55 | seed_only |
...
|---|---|---|
| rule30_lineage | 149 | timeline_graph.pass5 |
| jordan_lineage | 65 | timeline_graph.pass5 |
| lattice_forge_lineage | 209 | timeline_graph.pass5 |
| moonshine_lineage | 140 | timeline_graph.pass5 |
| forge_lineage | 82 | timeline_graph.pass5 |
...
**Adjacent band:** FLCR-33, FLCR-34, FLCR-36, FLCR-37
...
_Generated 2026-07-01T02:44:52.742700+00:00 — intake schema v1.1_
