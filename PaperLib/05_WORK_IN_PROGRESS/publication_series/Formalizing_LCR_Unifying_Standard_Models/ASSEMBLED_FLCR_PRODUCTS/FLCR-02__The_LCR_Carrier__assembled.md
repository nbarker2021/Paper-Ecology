...
| Evidence attached (review payload) | 984 |
| Review pass | 33 |
...
- `10.1109/jproc.2021.3058954` — seed reference (not primary paired DOI)
...
| PEEP bindings (routed) | 18 | required_direct | Includes LOCAL-GAP |
| Falsifier gaps (audit) | 18 | required_direct | From assembly audit |
...
_Generated 2026-07-01T06:22:54.628215+00:00 — intake schema v1.2_
