...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-11\formal.md` |
| Evidence attached (review payload) | 1092 |
| Review pass | 33 |
...
_… and 121 more receipt references._
...
- `10.3390/ijgi9030138` — seed reference (not primary paired DOI)
...
|---|---|---|---|
| Timeline nodes | 241 | supporting_context | Provenance graph pass5 |
| Timeline edges | 120 | supporting_context | Includes zip crosswalk |
| Registry DISCOVERY rows | 0 | supporting_context | Context only |
| Seed candidates | 23 | external_candidates | IRL review appendix |
| Ingress 80 records | 2 | external_candidates | Curated seeds only |
| PEEP bindings (routed) | 43 | required_direct | Includes LOCAL-GAP |
| Falsifier gaps (audit) | 43 | required_direct | From assembly audit |
...
- `EQ-REG-0044` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| CLAIM-10.3390/ijgi9030138 | 10.3390/ijgi9030138 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-11 | 10.3390/ijgi9030138 | ingress_80_curated_seed | 0.55 | seed_only |
...
| REG-509015 | None | registry_discovery_external_pair | 0.45 | unscored |
| REG-58f063 | None | registry_discovery_external_pair | 0.45 | unscored |
| REG-b6874e | None | registry_discovery_external_pair | 0.45 | unscored |
| REG-e86c0b | None | registry_discovery_external_pair | 0.45 | unscored |
| REG-f15d06 | None | registry_discovery_external_pair | 0.45 | unscored |
...
_… and 3 additional seed candidates._

## Timeline And Registry Context

| Motif | Node count | Provenance |
|---|---|---|
| rule30_lineage | 132 | timeline_graph.pass5 |
| jordan_lineage | 59 | timeline_graph.pass5 |
| lattice_forge_lineage | 178 | timeline_graph.pass5 |
| moonshine_lineage | 99 | timeline_graph.pass5 |
| forge_lineage | 69 | timeline_graph.pass5 |
| hub_receipt_lineage | 167 | timeline_graph.pass5 |
| sm_bridge_lineage | 109 | timeline_graph.pass5 |
...
**Adjacent band:** FLCR-09, FLCR-10, FLCR-12, FLCR-13
...
_Generated 2026-07-01T06:22:55.025255+00:00 — intake schema v1.2_
