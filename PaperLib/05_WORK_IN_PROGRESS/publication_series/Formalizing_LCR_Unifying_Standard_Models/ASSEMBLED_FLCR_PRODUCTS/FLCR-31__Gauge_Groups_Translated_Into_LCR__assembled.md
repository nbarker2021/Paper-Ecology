...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-31\formal.md` |
| Evidence attached (review payload) | 781 |
| Review pass | 33 |
...
- `10.1140/epjd/e2020-100571-8` — seed reference (not primary paired DOI)
...
| PEEP-2026-033 | 10.1007/s13398-025-01768-3 | ASSEMBLE | 85 | FLCR-31 Gauge Translation As Exceptional-E8 Comparator |
...
- `EQ-REG-0064` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| FORM-FORM-007 | None | foundational_form | 0.7 | classical_theorem_exempt |
| FORM-FORM-008 | None | foundational_form | 0.7 | classical_theorem_exempt |
| FORM-FORM-012 | None | foundational_form | 0.7 | classical_theorem_exempt |
| CLAIM-10.1140/epjd/e2020-1 | 10.1140/epjd/e2020-100571-8 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-31 | 10.1140/epjd/e2020-100571-8 | ingress_80_curated_seed | 0.55 | seed_only |
...
**Adjacent band:** FLCR-29, FLCR-30, FLCR-32, FLCR-33
...
_Generated 2026-07-01T06:22:55.976594+00:00 — intake schema v1.2_
