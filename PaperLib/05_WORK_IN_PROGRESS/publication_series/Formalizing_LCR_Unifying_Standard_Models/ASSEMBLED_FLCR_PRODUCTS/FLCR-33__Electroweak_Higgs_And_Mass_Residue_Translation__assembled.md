...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-33\formal.md` |
| Evidence attached (review payload) | 758 |
| Review pass | 33 |
...
| higgs_frame_mapping_receipt.json | formal_md | no | referenced |
| invariant_transfer_su2u1_in_su3_receipt.json | formal_md | no | referenced |
...
- `10.1007/jhep04(2021)279` — seed reference (not primary paired DOI)
...
| PEEP bindings (routed) | 13 | required_direct | Includes LOCAL-GAP |
| Falsifier gaps (audit) | 13 | required_direct | From assembly audit |
...
- `EQ-REG-0066` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.
...
| CLAIM-10.1007/jhep04(2021) | 10.1007/jhep04(2021)279 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-33 | 10.1007/jhep04(2021)279 | ingress_80_curated_seed | 0.55 | seed_only |
...
**Adjacent band:** FLCR-31, FLCR-32, FLCR-34, FLCR-35
...
_Generated 2026-07-01T06:22:56.052632+00:00 — intake schema v1.2_
