# Dimensional Ribbon Role - FLCR-06
...
order-1 slot-6 action: bind the carried state into causal edges or observer buffers
...
| Same family, next lift | `16` |
| Previous slot in window | `05` |
| Next slot in window | `07` |
