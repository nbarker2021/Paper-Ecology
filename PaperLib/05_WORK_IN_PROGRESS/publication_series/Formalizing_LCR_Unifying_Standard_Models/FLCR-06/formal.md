...
|---|---|---|---|
| paper lift enumeration | `receipt_bound_internal_result` | 8/8 LCR states succeeded; error walls=0; avg TarPit mass=0.507588. | This closes the paper-local finite lift readout, not every stronger physical interpretation. |
...
| oloid/path transport | `normal_form_result` | Path-carrier transport is closed as a geometry-of-transfer surface. | Measured path dynamics remain calibration-bound. |
...
| `supplements/05_INTERNAL_REASONING_SUPPLEMENT.md` | paper-local reasoning supplement contributing to definitions, proof sketch, and limitations |
...
| CQE-paper-06.25: Paper 6.25 - Toolkit for Causal Code | 69 | Paper 6.25 describes the review tools for causal code. These tools expose the typed dependency graph and its falsifiers; they do not declare the full 32-paper graph complete. The toolkit works with: ```text vertex = p... | Source-backed support; promotion requires the paper-local claim lane and evidence boundary. |
| CQE-PAPER-001-ENHANCED: CQE-PAPER-001-ENHANCED | 69 | *From DERIVATIONS.md §10 + Exact Named Map Audit* | Source-backed support; promotion requires the paper-local claim lane and evidence boundary. |
| WORKBOOK: Paper 05 — Workbook: Oloid Path Carrier Sheet (v1 — isomorphic to tool) | 67 | This workbook is supplemental validation and exposure material. It is not the paper's primary proof. It shows how the paper's mathematical state can be reconstructed with ordinary marks, tokens, strings, cards, or any... | Source-backed support; promotion requires the paper-local claim lane and evidence boundary. |
| Additional evidence cards | 11 total | The complete card inventory is maintained in the archive evidence matrix. | Cards are source-discovery aids until bound to paper-local evidence. |
...
`FLCR-06` (`Oloid Path Carrier And Transport Geometry`) occupies the `carrier_action` role at lift depth `0`.
...
|---|---|---|
| Legacy sources | `05_Oloid_Path_Carrier.md`, `supplements/05_INTERNAL_REASONING_SUPPLEMENT.md` | routed evidence |
...
| Figure | Role |
|---|---|
| FLCR-06-F1: Carrier path and invariant payload | Visualizes the proof object, routing, or boundary. |
| FLCR-06-F2: Evidence routing map | Visualizes the proof object, routing, or boundary. |
| FLCR-06-F3: Same-family lift context | Visualizes the proof object, routing, or boundary. |

| Table | Role |
|---|---|
| FLCR-06-T1: Carrier transport table | Records claim lanes, evidence, sources, or falsifiers. |
| FLCR-06-T2: Claim-lane/evidence-boundary table | Records claim lanes, evidence, sources, or falsifiers. |
| FLCR-06-T3: Archive evidence card and source-backed upgrade table | Records claim lanes, evidence, sources, or falsifiers. |
| FLCR-06-T4: Workbook replay and falsifier table | Records claim lanes, evidence, sources, or falsifiers. |
