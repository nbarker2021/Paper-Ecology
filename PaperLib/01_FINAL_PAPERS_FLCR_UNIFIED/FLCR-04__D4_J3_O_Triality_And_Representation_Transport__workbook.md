# FLCR-04 Workbook - D4, J3(O), Triality, And Representation Transport
...
- The `formal.md` file for `FLCR-04`.
...
| Step | Action |
|------|--------|
| Step 1 | Build a table with columns LCR, shell, complement pair, sheet, and diagonal carrier. |
| Step 2 | Round-trip each state through the atlas and verify identity recovery. |
| Step 3 | Pick one claim from FLCR-03 and restate it in each atlas coordinate. |
...
|---|---|---|
| Figures `FLCR-04-F1`, `FLCR-04-F2`, `FLCR-04-F3` | planned | Convert text schematics into final diagrams or leave as formal schematic figures. |
| Tables `FLCR-04-T1`-`FLCR-04-T4` | planned | Ensure all claim/evidence/source-card/workbook rows are complete. |
| Glossary | drafted | Replace generic term meanings with paper-local definitions. |
| Appendix FLCR-04-A | drafted | Attach receipt paths, verifier paths, source cards, and remaining external requirements. |
