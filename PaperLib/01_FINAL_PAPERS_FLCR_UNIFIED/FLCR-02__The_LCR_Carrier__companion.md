...
```text
received state -> The LCR Carrier -> produced state
```
...
For `FLCR-02`, the most important figure is `FLCR-02-F1`: State enumeration chart.
The most important table is `FLCR-02-T1`: State inventory table.
