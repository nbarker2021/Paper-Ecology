# Formal Contract - OPR-34

## Formal Carrier

This slot uses `boundary_action` at lift depth `3` to produce the following proof
form:
...
order-4 slot-4: type the boundary, repair row, or curvature-demand condition
