# Formal Contract - OPR-01

## Formal Carrier

This slot uses `enumeration_action` at lift depth `0` to produce the following proof
form:
...
order-1 slot-1: start the active one-dimensional action / enumerate the center state
