# Formal Contract - OPR-43

## Formal Carrier

This slot uses `fold_action` at lift depth `4` to produce the following proof
form:
...
order-5 slot-3: fold the initial action into a higher-dimensional representation
