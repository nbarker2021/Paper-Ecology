# Formal Contract - OPR-24

## Formal Carrier

This slot uses `boundary_action` at lift depth `2` to produce the following proof
form:
...
order-3 slot-4: type the boundary, repair row, or curvature-demand condition
