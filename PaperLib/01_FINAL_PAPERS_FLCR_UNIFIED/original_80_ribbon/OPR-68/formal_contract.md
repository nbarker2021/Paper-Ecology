# Formal Contract - OPR-68

## Formal Carrier

This slot uses `terminal_action` at lift depth `6` to produce the following proof
form:
...
order-7 slot-8: land into lattice, game, runtime, or terminal address surfaces
