# Formal Contract - OPR-65

## Formal Carrier

This slot uses `carrier_action` at lift depth `6` to produce the following proof
form:
...
order-7 slot-5: carry the state through a path, traversal, or admissible motion
