# Formal Contract - OPR-08

## Formal Carrier

This slot uses `terminal_action` at lift depth `0` to produce the following proof
form:
...
order-1 slot-8: land into lattice, game, runtime, or terminal address surfaces
