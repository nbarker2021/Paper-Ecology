# Formal Contract - OPR-33

## Formal Carrier

This slot uses `fold_action` at lift depth `3` to produce the following proof
form:
...
order-4 slot-3: fold the initial action into a higher-dimensional representation
