# Formal Contract - OPR-59

## Formal Carrier

This slot uses `window_action` at lift depth `5` to produce the following proof
form:
...
order-6 slot-9: read the ribbon through windows, meta-readouts, or synthesis bands
