# Formal Contract - OPR-31

## Formal Carrier

This slot uses `enumeration_action` at lift depth `3` to produce the following proof
form:
...
order-4 slot-1: start the active one-dimensional action / enumerate the center state
