# Formal Contract - OPR-12

## Formal Carrier

This slot uses `residual_action` at lift depth `1` to produce the following proof
form:
...
order-2 slot-2: mark the correction, residue, vacancy, or mismatch surface
