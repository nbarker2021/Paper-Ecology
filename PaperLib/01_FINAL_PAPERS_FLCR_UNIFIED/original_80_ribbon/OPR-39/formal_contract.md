# Formal Contract - OPR-39

## Formal Carrier

This slot uses `window_action` at lift depth `3` to produce the following proof
form:
...
order-4 slot-9: read the ribbon through windows, meta-readouts, or synthesis bands
