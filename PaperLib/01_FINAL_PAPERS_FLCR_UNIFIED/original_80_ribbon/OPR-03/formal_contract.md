# Formal Contract - OPR-03

## Formal Carrier

This slot uses `fold_action` at lift depth `0` to produce the following proof
form:
...
order-1 slot-3: fold the initial action into a higher-dimensional representation
