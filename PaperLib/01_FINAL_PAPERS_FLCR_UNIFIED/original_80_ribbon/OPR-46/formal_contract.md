# Formal Contract - OPR-46

## Formal Carrier

This slot uses `ledger_action` at lift depth `4` to produce the following proof
form:
...
order-5 slot-6: bind state into causal, observer, or synchronization ledgers
