# Formal Contract - OPR-58

## Formal Carrier

This slot uses `terminal_action` at lift depth `5` to produce the following proof
form:
...
order-6 slot-8: land into lattice, game, runtime, or terminal address surfaces
