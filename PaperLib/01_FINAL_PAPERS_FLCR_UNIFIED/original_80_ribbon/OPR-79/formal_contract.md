# Formal Contract - OPR-79

## Formal Carrier

This slot uses `window_action` at lift depth `7` to produce the following proof
form:
...
order-8 slot-9: read the ribbon through windows, meta-readouts, or synthesis bands
