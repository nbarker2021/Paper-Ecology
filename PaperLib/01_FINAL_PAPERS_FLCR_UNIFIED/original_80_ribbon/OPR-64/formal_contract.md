# Formal Contract - OPR-64

## Formal Carrier

This slot uses `boundary_action` at lift depth `6` to produce the following proof
form:
...
order-7 slot-4: type the boundary, repair row, or curvature-demand condition
