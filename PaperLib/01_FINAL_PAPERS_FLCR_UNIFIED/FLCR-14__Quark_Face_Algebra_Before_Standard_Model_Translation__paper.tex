...
\usepackage{array}
\begin{document}
\section*{FLCR-14 - Quark-Face Algebra Before Standard-Model Translation}
...
\noindent{}-- Defines quark-face algebra as a first-class FLCR object.\\
\noindent{}-- States the local result: six excited chart faces admit exact internal transport under the declared finite atlas and closure receipts.\\
\noindent{}-- Routes downstream use through claim lanes rather than inherited prose: FLCR-31 and FLCR-32 may translate the structure into gauge/QCD language only after citing this LCR-native base.\\
\noindent{}-- Preserves the residue boundary: measured quark identity, CKM data, and physical color calibration are deferred to translation papers.\\
...
\noindent{}-- `virtuous/13\_Standard-Model\_Quark-Face\_Transport\_VIRTUOUS.md`\\
\noindent{}-- `supplements/13\_INTERNAL\_REASONING\_SUPPLEMENT.md`\\
...
\noindent{}-- **Face algebra.** The finite chart operation on excited faces before physical naming.\\
\noindent{}-- **Translation guard.** The rule that Standard Model terms are downstream labels, not upstream premises.\\
...
\noindent\texttt{|-------|------|-----------|}\\
\noindent\texttt{| Theorem 14.1 | `receipt\_bound\_internal\_result` | six excited chart faces admit exact internal transport under the declared finite atlas and closure receipts |}\\
\noindent\texttt{| Proposition 14.2 | `normal\_form\_result` | quark-face algebra can be imported by later papers only through its declared source, receipt, and lane. |}\\
\noindent\texttt{| Protocol 14.3 | `falsifier\_or\_open\_obligation` | measured quark identity, CKM data, and physical color calibration are deferred to translation papers |}\\
...
\noindent\texttt{|---|---|---|---|---|---|}\\
\noindent\texttt{| Theorem 14.1 | finite/executable result | six excited chart faces admit exact internal transport under the declared finite atlas and closure receipts | receipt, validator, executable pass, generated artifact, or finite}\\
\noindent\texttt{| Proposition 14.2 | formal construction | quark-face algebra can be imported by later papers only through its declared source, receipt, and lane | definitions, normal-form construction, conversion rule, and downstream-u}\\
\noindent\texttt{| Protocol 14.3 | obligation/falsifier | measured quark identity, CKM data, and physical color calibration are deferred to translation papers | explicit missing derivation, adapter, receipt, dataset, comparator, or faile}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| Formal-system result | `FLCR-14` defines or uses **Quark-Face Algebra Before Standard-Model Translation** as a typed FLCR object with declared inputs, operations, outputs, and residue. | Definitions, formal claims, con}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| paper lift enumeration | `receipt\_bound\_internal\_result` | 8/8 LCR states succeeded; error walls=0; avg TarPit mass=0.508078. | This closes the paper-local finite lift readout, not every stronger physical interpretatio}\\
...
\noindent\texttt{| quark-face structural transport | `receipt\_bound\_internal\_result` | Quark-face transport is closed as finite structural color/face transport. | Measured QCD identity and dynamics remain comparator-bound. |}\\
...
\noindent{}-- measured quark identity, CKM data, and physical color calibration are deferred to translation papers\\
...
\noindent\texttt{| `NEW\_PAPER\_NEEDS.md` | route relevant obligations into this paper's burden table: NP-03 Cold-Start Terminal Selection And Fingerprint Map |}\\
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| Publication ID | `FLCR-14` |}\\
...
\noindent\texttt{|---|---|---|---|}\\
\noindent\texttt{| Theorem 14.1 | `receipt\_bound\_internal\_result` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | six excited chart faces admit exact internal transport under the declared finite at}\\
\noindent\texttt{| Proposition 14.2 | `normal\_form\_result` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | quark-face algebra can be imported by later papers only through its declared source, recei}\\
\noindent\texttt{| Protocol 14.3 | `falsifier\_or\_open\_obligation` | Receipt, source card, validator, citation, or CAM route named in the paper manifest | measured quark identity, CKM data, and physical color calibration are deferred to t}\\

\subsubsection*{Figure Plan}

\noindent\texttt{| Figure | Purpose | Caption |}\\
\noindent\texttt{|---|---|---|}\\
\noindent\texttt{| FLCR-14-F1 | Representation fold atlas | Schematic showing how `FLCR-14` turns its received state into the produced state while preserving claim lanes and residue boundaries. |}\\
\noindent\texttt{| FLCR-14-F2 | Evidence routing map | Diagram of source papers, archive cards, CAM/crystal routes, validators, and workbook replay paths used by this manuscript. |}\\
\noindent\texttt{| FLCR-14-F3 | Same-family lift context | Diagram placing this paper in the original `00-79` ribbon family and showing predecessor/successor slots. |}\\

\subsubsection*{In-Text Figure FLCR-14-F1: Representation fold atlas}
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-14-T1 | Face/representation correspondence table |}\\
\noindent\texttt{| FLCR-14-T2 | Claim-lane/evidence-boundary table |}\\
\noindent\texttt{| FLCR-14-T3 | Archive evidence card and source-backed upgrade table |}\\
\noindent\texttt{| FLCR-14-T4 | Workbook replay and falsifier table |}\\
...
\subsubsection*{Appendix FLCR-14-A: Evidence Package}
...
`FLCR-14` (`Quark-Face Algebra Before Standard-Model Translation`) occupies the `fold\_action` role at lift depth `1`.
...
\noindent\texttt{|---|---|---|}\\
\noindent\texttt{| Legacy sources | `13\_Standard\_Model\_Quark\_Face\_Transport.md`, `virtuous/13\_Standard-Model\_Quark-Face\_Transport\_VIRTUOUS.md`, `supplements/13\_INTERNAL\_REASONING\_SUPPLEMENT.md` | routed evidence |}\\
...
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-14-F1: Representation fold atlas | Visualizes the proof object, routing, or boundary. |}\\
\noindent\texttt{| FLCR-14-F2: Evidence routing map | Visualizes the proof object, routing, or boundary. |}\\
\noindent\texttt{| FLCR-14-F3: Same-family lift context | Visualizes the proof object, routing, or boundary. |}\\

\noindent\texttt{| Table | Role |}\\
\noindent\texttt{|---|---|}\\
\noindent\texttt{| FLCR-14-T1: Face/representation correspondence table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-14-T2: Claim-lane/evidence-boundary table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-14-T3: Archive evidence card and source-backed upgrade table | Records claim lanes, evidence, sources, or falsifiers. |}\\
\noindent\texttt{| FLCR-14-T4: Workbook replay and falsifier table | Records claim lanes, evidence, sources, or falsifiers. |}\\
