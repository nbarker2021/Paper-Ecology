...
**Proposition 18.2.** exceptional observer route can be imported by later papers only through its declared source, receipt, and lane.

**Protocol 18.3.** full Moonshine identification, measured observer physics, and unbounded exceptional closure remain separate obligations

### Claim lane reference

| Claim | Lane |
|---|---|
| Theorem 18.1 | `cam_crystal_reapplication_result` |
| Proposition 18.2 | `normal_form_result` |
| Protocol 18.3 | `falsifier_or_open_obligation` |
...
The proof strategy for FLCR-18 is a typed construction argument. The paper names exceptional route as the active object, binds it to the routed legacy and orbital sources, and then allows downstream use only through the declared claim lane. This preserves the full forward program: stronger ambitions remain explicit dependencies, calibration tasks, and falsifiers on the path to literal physics.
...
**Full audit assembly:** [`../ASSEMBLED_FLCR_PRODUCTS/FLCR-18__Exceptional_Towers_VOA_Routes_And_Observer_Face_Selection__assembled.md`](../ASSEMBLED_FLCR_PRODUCTS/FLCR-18__Exceptional_Towers_VOA_Routes_And_Observer_Face_Selection__assembled.md)
**Source truth:** `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-18\formal.md`
...
| `D:\CQE_CMPLX\CQECMPLX-Formal-Suite\lib\lattice_forge\receipts\CQE-paper-12-center_column_entropy_receipt.json` | no | closure_applied |
| `D:\CQE_CMPLX\CQECMPLX-Formal-Suite\lib\lattice_forge\receipts\CQE-paper-15-eight_states_one_dual_reading_receipt.json` | no | closure_applied |

_… and 36 additional receipt references in the assembled audit product._
...
- `LOCAL-GAP-0048`
- `LOCAL-GAP-0051`
- _… and 4 more in assembled product._
...
| LOCAL-GAP-0040 |  | REROUTE_OR_REPAIR |
| LOCAL-GAP-0041 |  | REROUTE_OR_REPAIR |
| LOCAL-GAP-0048 |  | REROUTE_OR_REPAIR |
| LOCAL-GAP-0051 |  | REROUTE_OR_REPAIR |

---

_Maximal reader manuscript — prose tier `maximal_publication` · renderer `full_formal_body_v2` · audit: `../ASSEMBLED_FLCR_PRODUCTS/FLCR-18__Exceptional_Towers_VOA_Routes_And_Observer_Face_Selection__assembled.md`._
