...
```text
received state -> Quark-Face Algebra Before Standard-Model Translation -> produced state
```
...
For `FLCR-14`, the most important figure is `FLCR-14-F1`: Representation fold atlas.
The most important table is `FLCR-14-T1`: Face/representation correspondence table.
