...
| EXT-RQM-CONSISTENT-2026: Quantum mechanics based on real numbers: A consistent description; DOI `10.1103/4k13-sdjh`; arXiv `2503.17307` | `standard_theorem_citation_bound_result` | Routes real-valued quantum mechanics into the reconstruction map as a major external support for separating physical prediction from representational convenience. | FLCR-40 should not cite this as proof of grand unification; it is a map entry and comparator. |
...
`FLCR-40` (`Grand Reconstruction Map And Trust-Removal Protocol`) occupies the `publication_overlay` role at lift depth `n/a`.
