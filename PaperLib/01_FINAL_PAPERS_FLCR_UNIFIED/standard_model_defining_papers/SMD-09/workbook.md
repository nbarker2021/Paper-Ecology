# SMD-09 Workbook - Neutrino Sector, Oscillation Evidence, And Beyond-Minimal Residues

## Purpose

This workbook turns `SMD-09` into a concrete Standard Model definition and comparator exercise. It is not a blank checklist. It is the place where a reviewer can take a
...
|---|---|---|---|
| Theorem 09.1 | `standard_theorem_citation_bound_result` | Neutrino-facing LCR claims must declare whether they are minimal-SM, experimentally established extension, or speculative residue. | Attach source/receipt/comparator and mark closure state. |
| Proposition 09.2 | `normal_form_result` | This definition can be consumed by an FLCR paper only after the external object, LCR mapping, boundary, and destination paper are named. | Attach source/receipt/comparator and mark closure state. |
...
| `IRL-NOBEL-NEUTRINO-2015` | Nobel advanced information: Neutrino Oscillations | Use as external definition or calibration source. |

## Closure-Now Rows

| Row | Closure statement | How to use it |
|---|---|---|
| Closure row 1 | Close the statement that oscillation evidence requires nonzero masses by citation. | Cite in destination paper only at stated scope. |
| Closure row 2 | Close LCR observer/flavor analogy only as a mapping row until a neutrino model is attached. | Cite in destination paper only at stated scope. |

## Open Or Calibration-Bound Rows

| Row | Obligation | Required next evidence |
|---|---|---|
| Obligation 1 | Absolute mass hierarchy and Majorana/Dirac status remain open or externally constrained. | Route to calibration, comparator, or falsifier. |
| Obligation 2 | LCR observer decomposition does not by itself prove a neutrino-sector claim. | Route to calibration, comparator, or falsifier. |

## Destination FLCR Routing

| Destination | Required use |
|---|---|
| FLCR-01 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-33 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-38 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-39 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-40 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-31 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-02 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-18 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-19 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-30 | Cite `SMD-09` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
...
| External object | Name the Standard Model or standard-physics object defined by `SMD-09`. |
...
```text
claim -> SMD-09 definition -> destination FLCR dependency -> lane
...
```text
SMD-09 source registry
SMD-09 destination FLCR-01 FLCR-33 FLCR-38 FLCR-39 FLCR-40 FLCR-31 FLCR-02 FLCR-18 FLCR-19 FLCR-30
SMD-09 closure rows
SMD-09 comparator falsifier boundary
SMD-09 CAM crystal reapplication evidence
```
