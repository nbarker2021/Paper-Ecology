# SMD-04 Workbook - Fermion Fields, Generations, Flavor, And Mixing

## Purpose

This workbook turns `SMD-04` into a concrete Standard Model definition and comparator exercise. It is not a blank checklist. It is the place where a reviewer can take a
...
|---|---|---|---|
| Theorem 04.1 | `standard_theorem_citation_bound_result` | Flavor and generation claims must distinguish structural indexing from measured mixing angles, phases, and masses. | Attach source/receipt/comparator and mark closure state. |
| Proposition 04.2 | `normal_form_result` | This definition can be consumed by an FLCR paper only after the external object, LCR mapping, boundary, and destination paper are named. | Attach source/receipt/comparator and mark closure state. |
...
|---|---|---|
| Closure row 1 | Close generation indexing only as an indexing/representation statement. | Cite in destination paper only at stated scope. |
| Closure row 2 | Close mixing formalism when a unitary matrix relation is stated and sourced. | Cite in destination paper only at stated scope. |

## Open Or Calibration-Bound Rows

| Row | Obligation | Required next evidence |
|---|---|---|
| Obligation 1 | Numerical CKM/PMNS agreement is open until values, uncertainties, dataset version, and comparator are attached. | Route to calibration, comparator, or falsifier. |
| Obligation 2 | A threefold LCR structure is not automatically a physical generation structure. | Route to calibration, comparator, or falsifier. |

## Destination FLCR Routing

| Destination | Required use |
|---|---|
| FLCR-01 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-31 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-32 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-33 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-38 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-40 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-02 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-18 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-19 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-30 | Cite `SMD-04` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
...
| External object | Name the Standard Model or standard-physics object defined by `SMD-04`. |
...
```text
claim -> SMD-04 definition -> destination FLCR dependency -> lane
...
```text
SMD-04 source registry
SMD-04 destination FLCR-01 FLCR-31 FLCR-32 FLCR-33 FLCR-38 FLCR-40 FLCR-02 FLCR-18 FLCR-19 FLCR-30
SMD-04 closure rows
SMD-04 comparator falsifier boundary
SMD-04 CAM crystal reapplication evidence
```
