# SMD-12 Workbook - ﻿# Standard Model Comparator And Falsifier Protocol

## Purpose

This workbook turns `SMD-12` into a concrete Standard Model definition and comparator exercise. It is not a blank checklist. It is the place where a reviewer can take a
...
|---|---|---|---|
| Theorem 12.1 | `standard_theorem_citation_bound_result` | A Standard Model synthesis claim is publishable only when the comparator row names source, equation, parameter, uncertainty, LCR mapping, and falsifier. | Attach source/receipt/comparator and mark closure state. |
| Proposition 12.2 | `normal_form_result` | This definition can be consumed by an FLCR paper only after the external object, LCR mapping, boundary, and destination paper are named. | Attach source/receipt/comparator and mark closure state. |
...
|---|---|---|
| Closure row 1 | Close standards/comparator governance as a formal protocol. | Cite in destination paper only at stated scope. |
| Closure row 2 | Close any claim whose lane has all required fields and no unresolved blocker. | Cite in destination paper only at stated scope. |

## Open Or Calibration-Bound Rows

| Row | Obligation | Required next evidence |
|---|---|---|
| Obligation 1 | A claim with missing comparator/falsifier fields remains an obligation even if rhetorically strong. | Route to calibration, comparator, or falsifier. |
| Obligation 2 | Grand synthesis remains blocked by any dependency that lacks its required lane evidence. | Route to calibration, comparator, or falsifier. |

## Destination FLCR Routing

| Destination | Required use |
|---|---|
| FLCR-01 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-39 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-40 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-31 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-02 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-18 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-19 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
| FLCR-30 | Cite `SMD-12` before using this Standard Model-facing object; attach lane, comparator, and boundary. |
...
| External object | Name the Standard Model or standard-physics object defined by `SMD-12`. |
...
```text
claim -> SMD-12 definition -> destination FLCR dependency -> lane
...
```text
SMD-12 source registry
SMD-12 destination FLCR-01 FLCR-39 FLCR-40 FLCR-31 FLCR-02 FLCR-18 FLCR-19 FLCR-30
SMD-12 closure rows
SMD-12 comparator falsifier boundary
SMD-12 CAM crystal reapplication evidence
```
