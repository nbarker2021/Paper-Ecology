# SMD-02 - Gauge Principle, Connections, And Local Symmetry
...
Standard Model definition; gauge principle; FLCR; claim lane; calibration; falsifier; closure bridge.

## 1. Contribution And Scope

- Defines **gauge principle** as an external target for later LCR translation.
...
- Routes this definition into: FLCR-31, FLCR-35, FLCR-40.
...
|---|---|---|
| Theorem 02.1 | `standard_theorem_citation_bound_result` | Gauge language may be translated into LCR only through an explicit map from local states and transport rules to connection, curvature, and invariant quantities. |
| Proposition 02.2 | `normal_form_result` | This definition can be consumed by an FLCR paper only after the external object, LCR mapping, boundary, and destination paper are named. |
| Protocol 02.3 | `falsifier_or_open_obligation` | Claims outside the closure rows remain obligations until their missing citation, receipt, normal-form, or calibration field is supplied. |
...
|---|---|
| `FLCR-31` | Cite SMD-02, state the LCR mapping, assign a claim lane, and attach comparator/falsifier fields before promoting the claim. |
| `FLCR-35` | Cite SMD-02, state the LCR mapping, assign a claim lane, and attach comparator/falsifier fields before promoting the claim. |
| `FLCR-40` | Cite SMD-02, state the LCR mapping, assign a claim lane, and attach comparator/falsifier fields before promoting the claim. |

## 10. Comparator And Falsifier Template

| Field | Required value |
|---|---|
| External object | `gauge principle` |
...
SMD-02 makes **gauge principle** usable by the FLCR suite without blurring definition, analogy, proof, and calibration. It closes the rows that standard formalism or FLCR receipts can actually close, and it names the rows that still require data.
