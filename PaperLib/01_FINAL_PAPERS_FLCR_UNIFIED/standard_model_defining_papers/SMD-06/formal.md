# SMD-06 - Electroweak Interaction And Symmetry Breaking
...
Standard Model definition; electroweak sector; FLCR; claim lane; calibration; falsifier; closure bridge.

## 1. Contribution And Scope

- Defines **electroweak sector** as an external target for later LCR translation.
...
- Routes this definition into: FLCR-31, FLCR-33, FLCR-40.
...
|---|---|---|
| Theorem 06.1 | `standard_theorem_citation_bound_result` | Electroweak claims require a bridge from LCR residue or sector accounting to SU(2)xU(1) fields, currents, and broken-phase observables. |
| Proposition 06.2 | `normal_form_result` | This definition can be consumed by an FLCR paper only after the external object, LCR mapping, boundary, and destination paper are named. |
| Protocol 06.3 | `falsifier_or_open_obligation` | Claims outside the closure rows remain obligations until their missing citation, receipt, normal-form, or calibration field is supplied. |
...
|---|---|
| `FLCR-31` | Cite SMD-06, state the LCR mapping, assign a claim lane, and attach comparator/falsifier fields before promoting the claim. |
| `FLCR-33` | Cite SMD-06, state the LCR mapping, assign a claim lane, and attach comparator/falsifier fields before promoting the claim. |
| `FLCR-40` | Cite SMD-06, state the LCR mapping, assign a claim lane, and attach comparator/falsifier fields before promoting the claim. |

## 10. Comparator And Falsifier Template

| Field | Required value |
|---|---|
| External object | `electroweak sector` |
...
SMD-06 makes **electroweak sector** usable by the FLCR suite without blurring definition, analogy, proof, and calibration. It closes the rows that standard formalism or FLCR receipts can actually close, and it names the rows that still require data.
