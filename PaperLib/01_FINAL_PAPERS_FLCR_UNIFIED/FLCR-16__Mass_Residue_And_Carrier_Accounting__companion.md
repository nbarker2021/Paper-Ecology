...
```text
received state -> Mass Residue And Carrier Accounting -> produced state
```
...
For `FLCR-16`, the most important figure is `FLCR-16-F1`: Carrier path and invariant payload.
The most important table is `FLCR-16-T1`: Carrier transport table.
