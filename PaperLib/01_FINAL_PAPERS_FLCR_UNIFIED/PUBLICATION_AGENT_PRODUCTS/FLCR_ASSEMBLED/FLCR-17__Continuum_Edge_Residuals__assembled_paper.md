...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-17\formal.md` |
| Evidence attached (review payload) | 4951 |
| Review pass | 30 |
...
_… and 250 more receipt references._
...
- `10.1038/s42254-021-00314-5` — **candidate** (seed; not paired to formal.md)
...
|---|---|---|---|
| Timeline nodes | 3196 | supporting_context | Provenance graph pass5 |
| Timeline edges | 392 | supporting_context | Includes zip crosswalk |
...
| PEEP bindings (routed) | 56 | required_direct | Includes LOCAL-GAP |
| Falsifier gaps (audit) | 55 | required_direct | From assembly audit |
...
- `EQ-REG-0050` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| FORM-FORM-014 | None | foundational_form | 0.7 | classical_theorem_exempt |
| CLAIM-10.1038/s42254-021-0 | 10.1038/s42254-021-00314-5 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-17 | 10.1038/s42254-021-00314-5 | ingress_80_curated_seed | 0.55 | seed_only |
...
| REG-8e54c6 | None | registry_discovery_external_pair | 0.45 | unscored |
| REG-9a9df7 | None | registry_discovery_external_pair | 0.45 | unscored |
| REG-bc4990 | None | registry_discovery_external_pair | 0.45 | unscored |
...
|---|---|---|
| rule30_lineage | 907 | timeline_graph.pass5 |
...
| forge_lineage | 1861 | timeline_graph.pass5 |
| hub_receipt_lineage | 152 | timeline_graph.pass5 |
| sm_bridge_lineage | 228 | timeline_graph.pass5 |
...
**Adjacent band:** FLCR-15, FLCR-16, FLCR-18, FLCR-19
...
_Generated 2026-07-01T02:44:51.783485+00:00 — intake schema v1.1_
