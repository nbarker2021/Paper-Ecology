...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-34\formal.md` |
| Evidence attached (review payload) | 740 |
| Review pass | 30 |
...
| PEEP-2026-028 | ASSEMBLE | Attached Evidence Index |  | IRL_equivalent_proposal_only |
...
- `10.1103/physrevlett.133.217002` — **candidate** (seed; not paired to formal.md)
...
| Falsifier gaps (audit) | 9 | required_direct | From assembly audit |
...
- `EQ-REG-0067` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| CLAIM-10.1103/physrevlett. | 10.1103/physrevlett.133.217002 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-34 | 10.1103/physrevlett.133.217002 | ingress_80_curated_seed | 0.55 | seed_only |
...
**Adjacent band:** FLCR-32, FLCR-33, FLCR-35, FLCR-36
...
_Generated 2026-07-01T02:44:52.703914+00:00 — intake schema v1.1_
