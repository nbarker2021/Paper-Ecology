...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-21\formal.md` |
| Evidence attached (review payload) | 4882 |
| Review pass | 30 |
...
|---|---|---|---|---|---|
| Theorem 21.1 | CAM route | the internal representation and candidate-generation path can be receipt-bound before fabrication or finite-element validation | CAM/crystal route, source node, projection, window, or addressable evidence artifact | routing and reapplication evidence; not a standalone physical proof | check the CAM source, route, and attached data are named |
| Proposition 21.2 | formal construction | materials forge can be imported by later papers only through its declared source, receipt, and lane | definitions, normal-form construction, conversion rule, and downstream-use boundary | internal formal coherence; no measured physical identity without a separate calibration row | check that the normal form is named and the conversion rule is explicit |
| Protocol 21.3 | obligation/falsifier | fabrication, finite-element performance, measured band data, and material claims require external calibration | explicit missing derivation, adapter, receipt, dataset, comparator, or failed test condition | does not negate satisfied lower-level rows | name the next binding action and owner surface |
...
|---|---|---|---|
| Formal-system result | `FLCR-21` defines or uses **Materials Candidate Generation** as a typed FLCR object with declared inputs, operations, outputs, and residue. | Definitions, formal claims, construction steps, and downstream-use rules are internally consistent and lane typed. | External physical truth, measured prediction, or identity with a standard theory. |
...
_… and 251 more receipt references._
...
- `10.1038/s41586-021-03499-y` — **candidate** (seed; not paired to formal.md)
...
|---|---|---|---|
| Timeline nodes | 3083 | supporting_context | Provenance graph pass5 |
| Timeline edges | 369 | supporting_context | Includes zip crosswalk |
| Registry DISCOVERY rows | 0 | supporting_context | Not promoted |
| Seed candidates | 100 | external_candidates | IRL review appendix |
| Ingress 80 records | 2 | external_candidates | Curated seeds only |
| PEEP bindings (routed) | 57 | required_direct | Includes LOCAL-GAP |
| Falsifier gaps (audit) | 56 | required_direct | From assembly audit |
...
- `EQ-REG-0054` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Package in PAIRWISE_EXTERNAL_EVIDENCE_PACKAGE_INDEX; run assembly pipeline.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| CLAIM-10.1038/s41586-021-0 | 10.1038/s41586-021-03499-y | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-21 | 10.1038/s41586-021-03499-y | ingress_80_curated_seed | 0.55 | seed_only |
...
| REG-e46826 | None | registry_discovery_external_pair | 0.45 | unscored |
| REG-f9ee61 | None | registry_discovery_external_pair | 0.45 | unscored |
| CAND-Q-10 | 10.1038/s41524-025-01826-9 | external_pairing_candidate_queue | 0.4 | promoted_or_bound |
| LOCAL-FOURPACK-007 |  | local_ability_seed | 0.83 | not_applicable_local_ability_seed |
| LOCAL-FORGE-REFORGE-013 |  | local_ability_seed | 0.79 | not_applicable_local_ability_seed |

_… and 80 additional seed candidates._
...
|---|---|---|
| rule30_lineage | 772 | timeline_graph.pass5 |
| jordan_lineage | 374 | timeline_graph.pass5 |
| lattice_forge_lineage | 2950 | timeline_graph.pass5 |
| moonshine_lineage | 387 | timeline_graph.pass5 |
| forge_lineage | 1945 | timeline_graph.pass5 |
| hub_receipt_lineage | 134 | timeline_graph.pass5 |
| sm_bridge_lineage | 183 | timeline_graph.pass5 |
...
**Adjacent band:** FLCR-19, FLCR-20, FLCR-22, FLCR-23
...
_Generated 2026-07-01T02:44:52.069963+00:00 — intake schema v1.1_
