...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-28\formal.md` |
| Evidence attached (review payload) | 3217 |
| Review pass | 30 |
...
- `10.1007/s00799-025-00431-x` — **candidate** (seed; not paired to formal.md)
- `10.14722/ndss.2020.24046` — **candidate** (seed; not paired to formal.md)
...
|---|---|---|---|
| Timeline nodes | 2112 | supporting_context | Provenance graph pass5 |
| Timeline edges | 176 | supporting_context | Includes zip crosswalk |
| Registry DISCOVERY rows | 0 | supporting_context | Not promoted |
| Seed candidates | 150 | external_candidates | IRL review appendix |
| Ingress 80 records | 2 | external_candidates | Curated seeds only |
| PEEP bindings (routed) | 52 | required_direct | Includes LOCAL-GAP |
| Falsifier gaps (audit) | 51 | required_direct | From assembly audit |
...
- `EQ-REG-0061` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| CLAIM-10.14722/ndss.2020.2 | 10.14722/ndss.2020.24046 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-28 | 10.14722/ndss.2020.24046 | ingress_80_curated_seed | 0.55 | seed_only |
...
| LOCAL-TMNBRAIN-004 |  | local_ability_seed | 0.84 | not_applicable_local_ability_seed |
| LOCAL-MINT-005 |  | local_ability_seed | 0.82 | not_applicable_local_ability_seed |
| LOCAL-SPLATFIELD-006 |  | local_ability_seed | 0.88 | not_applicable_local_ability_seed |

_… and 130 additional seed candidates._
...
|---|---|---|
| rule30_lineage | 354 | timeline_graph.pass5 |
| jordan_lineage | 161 | timeline_graph.pass5 |
| lattice_forge_lineage | 1958 | timeline_graph.pass5 |
| moonshine_lineage | 196 | timeline_graph.pass5 |
| forge_lineage | 1945 | timeline_graph.pass5 |
| hub_receipt_lineage | 70 | timeline_graph.pass5 |
| sm_bridge_lineage | 112 | timeline_graph.pass5 |
...
**Adjacent band:** FLCR-26, FLCR-27, FLCR-29, FLCR-30
...
_Generated 2026-07-01T02:44:52.417180+00:00 — intake schema v1.1_
