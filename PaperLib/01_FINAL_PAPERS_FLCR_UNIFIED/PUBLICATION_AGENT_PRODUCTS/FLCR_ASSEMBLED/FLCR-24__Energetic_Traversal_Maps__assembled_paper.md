...
| Evidence attached (review payload) | 2943 |
| Review pass | 30 |
| CMPLX-Standards fit | 70.3125% (`partial_inclusive`) |
...
| PEEP bindings (routed) | 26 | required_direct | Includes LOCAL-GAP |
...
- **documented_blocker** — DEFER_ASSEMBLE _(source: inventory)_
- **documented_blocker** — joule_thermodynamic_comparator_missing _(source: inventory)_
- **DEFER_ASSEMBLE** — DEFER_ASSEMBLE — comparator/external pair gate not closed. _(source: ribbon_state)_
- **DISCOVERY_STATUS** — Pipeline status DISCOVERY — no ASSEMBLE promotion from this product. _(source: assembly_audit)_

### Pending external pair queue

- `EQ-REG-0057` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.
...
- **Fit score:** 70.3125% — band `partial_inclusive`
- **Distance to perfect:** 0.296875
...
_Generated 2026-07-01T02:44:52.241066+00:00 — intake schema v1.1_
