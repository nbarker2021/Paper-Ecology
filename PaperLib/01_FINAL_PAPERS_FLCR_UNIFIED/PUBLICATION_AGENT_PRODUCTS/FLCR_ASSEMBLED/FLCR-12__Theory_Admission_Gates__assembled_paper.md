...
| Formal source | `D:\CQE_CMPLX\papers\active-rework\publication_series\Formalizing_LCR_Unifying_Standard_Models\FLCR-12\formal.md` |
| Evidence attached (review payload) | 2039 |
| Review pass | 30 |
...
_… and 170 more receipt references._
...
- `10.1177/1745691620970586` — **candidate** (seed; not paired to formal.md)
...
|---|---|---|---|
| Timeline nodes | 1108 | supporting_context | Provenance graph pass5 |
| Timeline edges | 77 | supporting_context | Includes zip crosswalk |
| Registry DISCOVERY rows | 0 | supporting_context | Not promoted |
| Seed candidates | 17 | external_candidates | IRL review appendix |
| Ingress 80 records | 2 | external_candidates | Curated seeds only |
| PEEP bindings (routed) | 47 | required_direct | Includes LOCAL-GAP |
...
- `EQ-REG-0045` — DISCOVERY_EXTERNAL_PAIR_REQUIRED: Find 2025/current peer-reviewed external paper and promote to PEEP package.

## Seed Appendix (IRL Review)

| Seed ID | DOI | Type | Confidence | NIST readiness |
|---|---|---|---|---|
| CLAIM-10.1177/174569162097 | 10.1177/1745691620970586 | lane_claim_queue_ingress | 0.6 | PASS |
| EXT80-12 | 10.1177/1745691620970586 | ingress_80_curated_seed | 0.55 | seed_only |
...
| lattice_forge_lineage | 775 | timeline_graph.pass5 |
| moonshine_lineage | 396 | timeline_graph.pass5 |
| forge_lineage | 257 | timeline_graph.pass5 |
| hub_receipt_lineage | 91 | timeline_graph.pass5 |
| sm_bridge_lineage | 136 | timeline_graph.pass5 |
...
**Adjacent band:** FLCR-10, FLCR-11, FLCR-13, FLCR-14
...
_Generated 2026-07-01T02:44:51.557125+00:00 — intake schema v1.1_
